...
class BaseNet(_Base):
    ...
    def forward(self, x: _torch.Tensor, g: _torch.Tensor, pad_start: _Optional[bool] = None, **kwargs):
        ...
        y = self._forward_mps_safe(x, g, **kwargs)
        if scalar:
            y = y[0]
        return y
    ...
    def _forward_mps_safe(self, x: _torch.Tensor, g: _torch.Tensor, **kwargs) -> _torch.Tensor:
        """
        ...
        if not self._mps_65536_fallback:
            try:
                return self._forward(x, g, **kwargs)
